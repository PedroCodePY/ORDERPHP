...
<body>
    ...
    <div class="Main">
        <div class="loginplace">
            ...
            <form name="Regist" action="SignUp.php" method="post" class="loginform">
                <div class="userform">
        ...
        function usernameExists($db, $username)
        {
            ...
            $sql = "SELECT COUNT(*) FROM orderuser WHERE Username = '$sanitizedUsername'";
        ...
        if (isset($_POST['submit'])) {
            ...
            if (usernameExists($db, $Username)) {
                ...
                $sql = "INSERT INTO orderuser(Name, Username, Password, Email, PhoneNumber) VALUES('$Name', '$Username', '$Password', '$Email', '$phoneNumber')";
